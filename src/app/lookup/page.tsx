                  ...
                  >
                    ...
                    <td className="px-3 py-3 text-center">
                      <div className="text-xs">
                        <div className="font-semibold text-yellow-700">{formatPrizeShort(perWinnerAmount(result.first_prize, result.first_winners), language, rates)}</div>
                        <div className="text-gray-600 dark:text-gray-400">{result.first_winners}{t('home.winners_suffix')}</div>
                      </div>
                    </td>
                    <td className="px-3 py-3 text-center">
                      <div className="text-xs">
                        <div className="font-semibold text-green-700">{formatPrizeShort(perWinnerAmount(result.second_prize, result.second_winners), language, rates)}</div>
                        <div className="text-gray-600 dark:text-gray-400">{result.second_winners}{t('home.winners_suffix')}</div>
                      </div>
                    </td>
                    <td className="px-3 py-3 text-center">
                      <div className="text-xs">
                        <div className="font-semibold text-purple-700">{formatPrizeShort(perWinnerAmount(result.third_prize, result.third_winners), language, rates)}</div>
              ...
              <div key={result.round} className="bg-white dark:bg-gray-800 rounded-lg shadow-md border border-gray-200 dark:border-gray-700 p-4">
                ...
                <div className="grid grid-cols-3 gap-3 text-xs">
                  <div className="text-center bg-yellow-50 dark:bg-yellow-900/20 p-2 rounded">
                    ...
                    <div className="font-medium text-yellow-700">{formatPrizeShort(perWinnerAmount(result.first_prize, result.first_winners), language, rates)}</div>
                    <div className="text-gray-600 dark:text-gray-400">{result.first_winners}{t('home.winners_suffix')}</div>
                  </div>
                  <div className="text-center bg-green-50 dark:bg-green-900/20 p-2 rounded">
                    ...
                    <div className="font-medium text-green-700">{formatPrizeShort(perWinnerAmount(result.second_prize, result.second_winners), language, rates)}</div>
                    <div className="text-gray-600 dark:text-gray-400">{result.second_winners}{t('home.winners_suffix')}</div>
                  </div>
                  <div className="text-center bg-purple-50 dark:bg-purple-900/20 p-2 rounded">
                    ...
                    <div className="font-medium text-purple-700">{formatPrizeShort(perWinnerAmount(result.third_prize, result.third_winners), language, rates)}</div>
                    <div className="text-gray-600 dark:text-gray-400">{result.third_winners}{t('home.winners_suffix')}</div>
                  </div>
                </div>
              </div>
