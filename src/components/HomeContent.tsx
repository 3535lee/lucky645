          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6">
            <div className="bg-gradient-to-r from-yellow-50 to-yellow-100 dark:from-yellow-900/20 dark:to-yellow-800/20 p-4 sm:p-6 rounded-lg border-l-4 border-yellow-400">
              <div className="text-center">
                ...
                <p className="text-lg sm:text-2xl font-bold text-yellow-600 mb-1 break-words">{formatPrize(perWinnerAmount(latestResult.first_prize, latestResult.first_winners), language, rates)}</p>
            ...
            <div className="bg-gradient-to-r from-green-50 to-green-100 dark:from-green-900/20 dark:to-green-800/20 p-4 sm:p-6 rounded-lg border-l-4 border-green-400">
              <div className="text-center">
                ...
                <p className="text-lg sm:text-2xl font-bold text-green-600 mb-1 break-words">{formatPrize(perWinnerAmount(latestResult.second_prize, latestResult.second_winners), language, rates)}</p>
            ...
            <div className="bg-gradient-to-r from-purple-50 to-purple-100 dark:from-purple-900/20 dark:to-purple-800/20 p-4 sm:p-6 rounded-lg border-l-4 border-purple-400">
              <div className="text-center">
                ...
                <p className="text-lg sm:text-2xl font-bold text-purple-600 mb-1 break-words">{formatPrize(perWinnerAmount(latestResult.third_prize, latestResult.third_winners), language, rates)}</p>
